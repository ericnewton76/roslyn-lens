...
- [General .NET Detectors](detectors/general.md) — AP001–AP009
- [Domain-Specific Detectors](detectors/domain.md) — GR-GUID, GR-SECRET, GR-DTO, etc.

## Architecture

- [How It Works](architecture/how-it-works.md)
- [Adding a Detector](architecture/adding-a-detector.md)
- [Adding a Tool](architecture/adding-a-tool.md)
